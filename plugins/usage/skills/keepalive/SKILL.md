...
Use this skill only for screen-based `/goal resume` sending. Usage polling and prediction live in `$usage:forecast`; this skill reads that forecast and wakes existing interactive Codex sessions.
